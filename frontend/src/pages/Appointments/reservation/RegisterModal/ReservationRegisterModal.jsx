...
export default function ReservationRegisterModal({ isOpen, onSuccess, onClose, setStatusMessage, treatments, workers, places, appointments}) {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setStatusMessage({ message: "Erro ao registrar reserva", type: "error" });
            }
        } catch (error) {
...
//======================================================================================================
    ...
    return (
        <RegisterModal title="Nova Reserva" onSubmit={handleSubmit(onSubmit, handleError)} isOpen={isOpen} onClose={onClose}>
            <Controller name="treatmentId" control={control} rules={{ required: "O tratamento é obrigatório" }}
                render={({ field }) => (
            ...
            <Controller name="timeRange" control={control} rules={{ required: "A data é obrigatória" }}
                render={({ field }) => (
                    <DatePicker
                        ...
                        appointments={appointments} selectedWorker={selectedWorker} selectedPlace={selectedPlace}
