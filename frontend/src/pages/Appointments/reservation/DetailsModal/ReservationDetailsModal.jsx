...
export default function ReservationDetailsModal({ appointment, onDelete, isOpen, onClose, onUpdate,
        setStatusMessage, treatments, workers, places, appointments
    }) {
    const contextFields = {
...
//====================================================================================================
    ...
    return (
        <DetailsModal title={isEditing ? "Edição da Reserva" : "Detalhes da Reserva"} isOpen={isOpen}
