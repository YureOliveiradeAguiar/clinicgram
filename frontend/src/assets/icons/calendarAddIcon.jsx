export default function CalendarAddIcon ({ width = 60, height = 60, fill = 'currentColor', className }) {
    return (
        <svg stroke='none' fill={fill} width={width} height={height} viewBox="0 -960 960 960" xmlns="http://www.w3.org/2000/svg" className={className}>
