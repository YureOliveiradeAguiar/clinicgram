export default function BarChartIcon ({ width = 60, height = 60, fill = 'currentColor', className }) {
    return (
        <svg stroke="none" fill={fill} height={height} width={width} className={className} viewBox="0 -960 960 960" xmlns="http://www.w3.org/2000/svg">
