...
import ClientRegister from '@/pages/Clients/clientRegister/ClientRegister.jsx';
import StaffRegister from './pages/Staff/staffRegister/StaffRegister.jsx';
import Clients from '@/pages/Clients/clientListing/Clients.jsx';
			...
			<Router>
				<Routes>
					...
					<Route element={<Layout />}>
						...
						<Route path="/staff/new" element={<RequireAuth><StaffRegister /></RequireAuth>} />
